...
public class Dashboard extends JFrame implements ActionListener, MouseListener, Runnable {
    ...
    Dashboard(String username) {
        ...
        // Add Dashboard logo
/* 
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("ICONS/logo_tour.jpg"));
        ...
        */
        ...
        p2.setLayout(null);
        p2.setBounds(0, 60, 250, 460);
        p2.setBackground(Color.LIGHT_GRAY);
        add(p2);

        // copyright label

        JLabel copyright = new JLabel("© 2024 OOADJ Project");
        copyright.setBounds(10, 420, 160, 25);
        p2.add(copyright);
...
*/
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("ICONS/dashboard_home.jpg"));
        ...
        l4 = new JLabel("  Tourism Management System - By Ankita_Vaishnavi_Khanak_Kishan ");
        l4.setBounds(400, 100, 1200, 70);
        l4.setForeground(Color.BLACK);
        l4.setBorder(BorderFactory.createLineBorder(Color.BLACK));
        l4.setFont(new Font("Serif", Font.BOLD + Font.ITALIC, 35));
        l1.add(l4);
