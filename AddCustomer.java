...
public class AddCustomer extends JFrame implements ActionListener {   // responsible for creating a window to add customer details and handling user actions
    JTextField t1, t2, t3, t4, t5, t6, t7, genderField;
    JComboBox<String> c1;
    JRadioButton r1, r2;
    JButton b1, b2;
    ImageIcon male;
    ...
    AddCustomer(String username) {  // takes username as a parameter

        // GUI Components used : JLabel , JTextField , JComboBox , JButton
        ...
        genderField = new JTextField(); // Add a JTextField for gender input
        genderField.setBounds(170, 225, 200, 25);
        add(genderField);
    ...
    // The actionPerformed() method is implemented to handle actions performed by the user, specifically button clicks (b1 and b2).

    @Override
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {

            // interacts with a database using the Conns class to insert customer details into the database
            Conns c = new Conns();
            ...
            String radio = genderField.getText();
            ...
            try {
                ...
                // JOptionPane is used to provide feedback to the user in case of successful insertion of customer details or any exceptions.
