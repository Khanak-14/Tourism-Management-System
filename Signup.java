...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup() {
        ...
        l7.setBounds(490, 40, 250, 250);
        add(l7);

        JLabel l8 = new JLabel("Let's get you set up ");
        l8.setBounds(510, 290, 220, 25);
        l8.setFont(new Font("MV Boli", Font.BOLD, 20));
        add(l8);

        JLabel l9 = new JLabel("It should only take you a minute to connect");
        l9.setBounds(460, 325, 300, 20);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            String role = c2.getSelectedItem();
